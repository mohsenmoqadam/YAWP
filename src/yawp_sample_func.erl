...
encode_msg(Msg, Opts) ->
    ...
    case Msg of
      #'yawp.sample.func.Call'{} ->
	  'e_msg_yawp.sample.func.Call'(Msg);
      #'yawp.sample.type.Type'{} ->
	  'e_msg_yawp.sample.type.Type'(Msg)
    end.


'e_msg_yawp.sample.func.Call'(_Msg) -> <<>>.
...
decode_msg(Bin, MsgName) when is_binary(Bin) ->
    case MsgName of
      'yawp.sample.func.Call' ->
	  'd_msg_yawp.sample.func.Call'(Bin);
      'yawp.sample.type.Type' ->
...
'd_msg_yawp.sample.func.Call'(Bin) ->
    'dfp_read_field_def_yawp.sample.func.Call'(Bin, 0, 0).

'dfp_read_field_def_yawp.sample.func.Call'(<<>>, 0,
					   0) ->
    #'yawp.sample.func.Call'{};
'dfp_read_field_def_yawp.sample.func.Call'(Other, Z1,
					   Z2) ->
    'dg_read_field_def_yawp.sample.func.Call'(Other, Z1,
					      Z2).

'dg_read_field_def_yawp.sample.func.Call'(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc)
    when N < 32 - 7 ->
    'dg_read_field_def_yawp.sample.func.Call'(Rest, N + 7,
					      X bsl N + Acc);
'dg_read_field_def_yawp.sample.func.Call'(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 -> 'skip_varint_yawp.sample.func.Call'(Rest, 0, 0);
      1 -> 'skip_64_yawp.sample.func.Call'(Rest, 0, 0);
      2 ->
	  'skip_length_delimited_yawp.sample.func.Call'(Rest, 0,
							0);
      5 -> 'skip_32_yawp.sample.func.Call'(Rest, 0, 0)
    end;
'dg_read_field_def_yawp.sample.func.Call'(<<>>, 0, 0) ->
    #'yawp.sample.func.Call'{}.

'skip_varint_yawp.sample.func.Call'(<<1:1, _:7,
				      Rest/binary>>,
				    Z1, Z2) ->
    'skip_varint_yawp.sample.func.Call'(Rest, Z1, Z2);
'skip_varint_yawp.sample.func.Call'(<<0:1, _:7,
				      Rest/binary>>,
				    Z1, Z2) ->
    'dfp_read_field_def_yawp.sample.func.Call'(Rest, Z1,
					       Z2).


'skip_length_delimited_yawp.sample.func.Call'(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc)
    when N < 57 ->
    'skip_length_delimited_yawp.sample.func.Call'(Rest,
						  N + 7, X bsl N + Acc);
'skip_length_delimited_yawp.sample.func.Call'(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_yawp.sample.func.Call'(Rest2, 0, 0).


'skip_32_yawp.sample.func.Call'(<<_:32, Rest/binary>>,
				Z1, Z2) ->
    'dfp_read_field_def_yawp.sample.func.Call'(Rest, Z1,
					       Z2).


'skip_64_yawp.sample.func.Call'(<<_:64, Rest/binary>>,
				Z1, Z2) ->
    'dfp_read_field_def_yawp.sample.func.Call'(Rest, Z1,
					       Z2).
...
merge_msgs(Prev, New)
    ...
    case Prev of
      #'yawp.sample.func.Call'{} ->
	  'merge_msg_yawp.sample.func.Call'(Prev, New);
      #'yawp.sample.type.Type'{} ->
	  'merge_msg_yawp.sample.type.Type'(Prev, New)
    end.

'merge_msg_yawp.sample.func.Call'(_Prev, New) -> New.
...
verify_msg(Msg) ->
    case Msg of
      #'yawp.sample.func.Call'{} ->
	  'v_msg_yawp.sample.func.Call'(Msg,
					['yawp.sample.func.Call']);
      #'yawp.sample.type.Type'{} ->
...
'v_msg_yawp.sample.func.Call'(#'yawp.sample.func.Call'{},
			      _Path) ->
    ok.
...
get_msg_defs() ->
    [{{msg, 'yawp.sample.func.Call'}, []},
     {{msg, 'yawp.sample.type.Type'}, []}].


get_msg_names() ->
    ['yawp.sample.func.Call', 'yawp.sample.type.Type'].
...
find_msg_def('yawp.sample.func.Call') -> [];
...
get_package_name() -> 'yawp.sample.func'.
